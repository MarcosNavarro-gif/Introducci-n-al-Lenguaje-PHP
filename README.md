...
Lógica y Control: Uso de condicionales (if / else) para la toma de decisiones.
...
3. Calculadora (Lab2): Script en PHP que permite sumar, restar, multiplicar y redondear números según la opción seleccionada por el usuario.
